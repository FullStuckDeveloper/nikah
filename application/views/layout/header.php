...
<header class="main-header">
  ...
  <!-- </ul> -->
  <div class="navbar col-sm-12" style="border:0px;">
    <!-- <div class="col-sm-1"></div> -->
    <a href="<?php echo site_url('nikah'); ?>" class="<?php if($this->uri->segment(2)==""){echo "active";}?>" style="width:20%;"><i class="fa fa-home fa-2x"></i>
      <!-- </br>Beranda -->
    </a>
    <a href="<?php echo site_url('nikah/acara'); ?>" class="<?php if($this->uri->segment(2)=="acara"){echo "active";}?>" style="width:20%;"><i class="fa fa-calendar fa-2x"></i>
      <!-- </br>Acara -->
    </a>
    <a href="<?php echo site_url('nikah/ucapan'); ?>" class="<?php if($this->uri->segment(2)=="ucapan"){echo "active";}?>" style="width:20%;"><i class="fa fa-comments-o fa-2x"></i>
      <!-- </br>Ucapan -->
    </a>
    <a href="<?php echo site_url('nikah/lokasi'); ?>" class="<?php if($this->uri->segment(2)=="lokasi"){echo "active";}?>" style="width:20%;"><i class="fa fa-map-marker fa-2x"></i>
      <!-- </br>Lokasi -->
    </a>
    <a href="<?php echo site_url('nikah/galeri'); ?>" class="<?php if($this->uri->segment(2)=="galeri"){echo "active";}?>" style="width:20%;"><i class="fa fa-camera-retro fa-2x"></i>
      <!-- </br>Galeri -->
    </a>
    <!-- <div class="col-sm-1"></div> -->
  </div>
